...
public class VideoRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private Class<? extends BaseFilter> mNowSvClazz = SvSpiritFreedFilter.class;
...
//      mShowFilter.draw(mTextureID);
        ...
        //短视频特效处理
        if (mNowSvClazz != null) {
            mTextureID = mSvTool.processTexture(mTextureID, mWidth, mHeight, mNowSvClazz);
        }
